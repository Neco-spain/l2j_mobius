...
public class CursedWeapon implements INamable
{
	...
	public void cursedOnLogin()
	{
		...
		final SystemMessage msg = new SystemMessage(SystemMessageId.THE_S2_S_OWNER_IS_IN_S1_THE_TREASURE_CHEST_CONTAINS_S2_ADENA_FIXED_REWARD_S3_ADDITIONAL_REWARD_S4_THE_ADENA_WILL_BE_GIVEN_TO_THE_LAST_OWNER_AT_23_59);
		...
		final SystemMessage msg2 = new SystemMessage(SystemMessageId.S1_HAS_S2_MIN_OF_USAGE_TIME_REMAINING);
